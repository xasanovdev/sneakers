...
function App() {
  ...
  useEffect(() => {
    axios.get("https://643b94fa70ea0e660296b34a.mockapi.io/sneakers").then((response) => {
      setItems(response.data);
    })
    axios.get("https://643b94fa70ea0e660296b34a.mockapi.io/cart").then((response) => {
  ...
  const onAddToCart =(obj) => {
    axios.post("https://643b94fa70ea0e660296b34a.mockapi.io/cart",obj);
    setCartItems((prev) => [...prev, obj]);
  }
  const onRemoveItem = (id) => {
    axios.delete(`https://643b94fa70ea0e660296b34a.mockapi.io/cart/${id}`);
